...
describe('Switch', function(){
  ...
  var prefixesSwitch2 = [564182, 633110];

  for (var i=0; i<prefixesSwitch1.length; i++) {
    (function(prefix) {
      ...
      it('has a prefix of ' + prefix + ' and a length of 18', function() {
        detectNetwork(prefix + '12345678912345').should.equal('Switch');
      });

      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        detectNetwork(prefix + '123456789123456').should.equal('Switch');
      });
    })(prefixesSwitch1[i])
  }

  for (var i=0; i<prefixesSwitch2.length; i++) {
    (function(prefix) {
